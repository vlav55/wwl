...
if(isset($_GET['promocode'])) {
	$tm=time();
	$promo=substr($_GET['promocode'],0,12);
	$r=$db->fetch_assoc($db->query("SELECT * FROM promocodes
		WHERE uid='$uid'
...
if($db->dlookup("id","promocodes","uid='$uid' AND promocode='sarafan' AND tm2>'".time()."'"))
	$promo_hidden="";
...
<html lang="ru">
  ...
  <body class="body">
    <header class="header">
      <div class="header__container">
        ...
        <nav class="header__nav">
          <ul class="header__ul">
            <li class="header__li">
              <a href="index.html" class="header__a one">О сервисе</a>
            </li>
            <li class="header__li">
              <a href="index.html" class="header__a two active">Тарифы</a>
            </li>
            <li class="header__li">
              <a href="index.html" class="header__a three">Партнерская программа</a>
            </li>
            <li class="header__li">
              <a href="index.html" class="header__a four">Вопросы</a>
            </li>
          </ul>
        </nav>
    ...
    <main class="main main-one">
      <section class="rate">
        <div class="container">
          <a class="rate__link" href="index.html">
            <svg
              width="30"
              height="15"
              viewBox="0 0 30 15"
          ...
          <h1 class="rate__title">
            <?=$order_description?>
            <span class="rate__month"><? print $order_term==30?"1 месяц":" дней";?></span>
          </h1>
          ...
          <?
			if($tm=$db->price2_chk_timeto($uid,$product_id))
				print "<div><br>Скидка действует до: <b>".date("d.m.Y H:i",$tm)."</b></div>";
          ?>
          <form class="promo" action="mail.php" enctype="multipart/form-data" method="POST">
            <div class="promo__left">
              <div class="promo__left-div1">У меня есть промокод:</div>
              <div class="promo__left-not-found">Промокод не найден!</div>
            </div>
            <div class="promo__right">
              <input type="text" class="promo__right-input" placeholder="Промокод">
          ...
          <form id='f1' class="pay form" action="#" enctype="multipart/form-data" method="POST">
            ...
            <div class="pay__text-2">
              ...
              электронных платежей <span>PRODAMUS</span>. Представленные Вами данные полностью
              защищены и никто, включая наш интернет-магазин, не может их получить.
            </div>
            ...
            <div class="pay__checkbox">
              <div class="checkbox-wrapper">
                <input id="chk2" class="input__checkbox" type="checkbox" checked name="agree" />
              </div>
              <div class="pay__checkbox-right">
            ...
            <button id='go_prodamus' class="pay__button" type="button">Перейти к оплате</button>
          </form>
			<div class='text-left mt-5 p3'  style='text-align:center; margin-top:40px;'>
				<img class='p-1' src="/images/mc.png" height='64' style='height:64px;'>
				<img class='p-1' src="/images/visa.png" height='64'  style='height:64px;'>
				<img class='p-1' src="/images/mir.png" height='64'  style='height:64px;'>
				<img class='p-1' src="/images/verified.png" height='64'  style='height:64px;'>
				<img class='p-1' src="/images/MIRaccept.png" height='64'  style='height:64px;'>
			</div>
        </div>
      </section>
    </main>
    ...
    <div class="login" id="login">
      ...
      <div class="login__agree">
        ...
        <a class="back-to-home" href="index.html">Тарифный план</a>
      </div>
    </div>
      ...
      <nav class="mobile-menu__nav" onclick="event.stopPropagation()">
        <ul class="mobile-menu__ul">
          <li class="mobile-menu__li">
            <a class="mobile-menu__link one" href="index.html">О сервисе</a>
          </li>
          <li class="mobile-menu__li">
            <a class="mobile-menu__link two" href="index.html">Тарифы</a>
          </li>
          <li class="mobile-menu__li">
            <a class="mobile-menu__link three" href="index.html">Партнерская программа</a>
          </li>
          <li class="mobile-menu__li">
            <a class="mobile-menu__link four" href="index.html">Вопросы</a>
          </li>
        </ul>
      </nav>
    </div>
...
<script type="text/javascript">
	...
	$("#go_prodamus").click(function() {
		...
		if($("#client_name").val().trim()=="") {
			...
			$('#f1').attr('action', '/db1/pay_prodamus.php').submit();
		}
	});
</script>
