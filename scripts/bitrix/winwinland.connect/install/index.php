...
class winwinland_connect extends CModule
{
    public $MODULE_ID = "winwinland.connect";
    ...
    {
        $this->MODULE_ID = "winwinland.connect";
        ...
        $this->MODULE_VERSION_DATE = "2025-02-01 00:00:00";
    }
