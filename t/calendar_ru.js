...
document.write('<table id="fc" class="cal_tm_delayed" style="position:absolute;z-index:10;border-collapse:collapse;background:#FFFFFF;border:1px solid #777;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none;" cellpadding="2">');
...
document.write('<tr style="background:#777;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#AAA" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
function cs_over(e) {
	evtTgt(EvtObj(e)).style.background='#AAA';
}
function cs_out(e) {
...
function f_cps(obj) {
	...
	obj.style.border='1px solid #777';//'1px solid #606060';
