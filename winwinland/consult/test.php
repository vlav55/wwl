...
<head>
  ...
  <link rel="stylesheet" href="https://winwinland.ru/A.fonts,,_fonts.css+css,,_styles.css,Mcc.PtyTYYtLoN.css.pagespeed.cf.w1XZOeSDhF.css"/>
				...
				<p>Заполните ваши данные и мы сможем вам помочь настроить эффективную партнерскую программу для увеличения продаж. 
				  ...
				  <form id='f1' class="pay form" action="#" enctype="multipart/form-data" method="POST">
					<div class="login__item">
					  <input class="login__name login-input" id="client_name" name="fio" type="text" value="" placeholder="ФИО (*)">
					</div>
					<div class="login__item">
					  <input id="client_phone" class="login__phone_ login-input" name="phone" type="tel" value="" placeholder="Телефон (*)">
					</div>
					<div class="login__item short">
					  <input id="client_email" class="login__email login-input" name="email" type="email" value="" placeholder="Эл. почта">
					</div>
					...
					<input type="hidden" name="land_num" value="4"/>
					...
					<input type="hidden" name="utm_ab" value=""/>
					<br>
