	...
	<span style='margin-top:10px; padding:10px; text-align:right;'>
            ...
            <div class="possibilities__right">
              <div class="possibilities__item">
                ...
                <div class="possibilities__item-right">
                  Вы подключаетесь к сервису Winwinland и создаете собственную партнерскую программу;
                </div>
              </div>
              <div class="possibilities__item">
                <div class="possibilities__item-left">  2.</div>
                <div class="possibilities__item-right">
                  Зарегистрироваться в партнерской программе могут ваши клиенты, блогеры, лидеры мнений, сотрудники, партнеры по бизнесу и кроссмаркетингу;
                </div>
              </div>
              <div class="possibilities__item">
                <div class="possibilities__item-left">3.</div>
                <div class="possibilities__item-right">
                  Они получают партнерские ссылки, личные кабинеты, вы настраиваете для них систему вознаграждений. Все это делается автоматически с помощью Winwinland;
                </div>
              </div>
              <div class="possibilities__item">
                <div class="possibilities__item-left">4.</div>
                <div class="possibilities__item-right">
                  Партнеры вас рекомендуют знакомым, в соцсетях, в блогах, в сообществах. При этом они указывают свои партнерские ссылки;
				</div>
              </div>
              <div class="possibilities__item">
                <div class="possibilities__item-left">5.</div>
                <div class="possibilities__item-right">
                  Платформа учитывает всех пользователей, перешедших по&nbsp;этим ссылкам, закрепляет за партнерами и&nbsp;начисляет партнерам вознаграждение после&nbsp;продажи;
				</div>
              </div>
              <div class="possibilities__item">
                <div class="possibilities__item-left">6.</div>
                <div class="possibilities__item-right">
                  Вы получаете лояльных клиентов с рекомендаций, а оплачиваете только за результат;
				</div>
              </div>
              <div class="possibilities__item">
				<div class="possibilities__item-left">7.</div>
				<div class="possibilities__item-right">
				  Платформа помогает вам в работе. Есть CRM система, модуль партнерских программ, создание лэндингов, чат ботов, рассылки, прием платежей с карт, искусственный интеллект и множество интеграций;
				</div>
              </div>
              <div class="possibilities__item">
        ...
        <div class="possibilities">
          ...
          <h3 class="possibilities__suptitle title">
            Создайте собственную партнерскую программу чтобы:
          </h3>
          <div class="function__items">
            <div class="function__item fi-1">
              ...
              <div class="function__item-text">Получать лояльных клиентов от рекомендаций</div>
            </div>
            ...
            <div class="function__item mi-2">
              ...
              <div class="function__item-text">Сотрудничать с блогерами с оплатой за результат </div>
            </div>
            ...
            <div class="function__item mi-3">
              ...
              <div class="function__item-text">Увеличить в десятки раз сарафанное радио</div>
            </div>
          </div>
<h3 class="possibilities__suptitle title">
<!--
...
-->
          ...
          <div class="traffic__left">
            ...
            <ul class="traffic__ul">
              <li class="traffic__li">
                Создаем автоворонку продаж. <span style='font-weight:normal;' >Используем встроенный конструктор для&nbsp;анонсов мероприятий, промо-страниц, карточек товаров и&nbsp;различных лэндингов. Быстрый запуск без&nbsp;программиста.</span>
              </li>
              <li class="traffic__li">
               Контакты всех клиентов сами попадают в&nbsp;CRM. <span style='font-weight:300;'>Доступ к&nbsp;базе из&nbsp;любой точки через интернет, история и&nbsp;отчеты по&nbsp;продажам и&nbsp;по&nbsp;работе партнеров. </span>
              </li>
              <li class="traffic__li">
               Упрощаем оплату ваших товаров и&nbsp;услуг. <span style='font-weight:normal;' >Прием платежей с&nbsp;карт прямо на&nbsp;вашем сайте и&nbsp;банковские рассрочки для дорогих продуктов. </span>
              </li>
              <li class="traffic__li">Настраиваем напоминания и&nbsp;авторассылки для клиентов. <span style='font-weight:normal;' >Платформа отправит их&nbsp;своевременно: по&nbsp;событию или по&nbsp;времени. Рассылка в&nbsp;Вконтакте и&nbsp;Телеграм&nbsp;&mdash; бесплатно.</span></li>
            </ul>
            <div>
        ...
        <div class="traffic__bottom traffic__bottom-hidden" id="consult">
        </div>
        <a href="consult/?<?=$par_url?>" class="service__link" >Связаться с нами</a>
        ...
        <div class="monetization">
          ...
          <div class="monetization__items">
            <div class="monetization__item mi-1">
              ...
              <div class="monetization__item-text">Трафик от партнеров</div>
            </div>
            <div class="monetization__item arrow mi-2">
              <img src="img/monetization-arrow.svg" alt="arrow" loading="lazy">
            </div>
        ...
        <div class="versality">
          <h3 class="versality__title title">Универсально для компаний и предпринимателей</h3>
<!--
...
-->
              <li class="versality__li">
                ...
                <span>Компании различного профиля b2b и b2c</span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
                  <img src="img/versatility-10.svg" alt="img" loading="lazy">
                </div>
                <span>Организаторы мероприятий</span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
                  <img src="img/versatility-9.svg" alt="img" loading="lazy">
                </div>
                <span>Недвижимость, дизайн интерьеров, ремонт, производство мебели</span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
                  <img src="img/versatility-11.svg" alt="img" loading="lazy">
                </div>
                <span>Селлеры маркетплэйсов и <a href='pdf/winwinland_insales.pdf' class='' target='_blank'>интернет-магазины</a></span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
                  <img src="img/versatility-5.svg" alt="img" loading="lazy">
                </div>
                <span>Онлайн школы и инфобизнес</span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
                  <img src="img/versatility-2.svg" alt="img" loading="lazy">
                </div>
                <span>Психологи, коучи, тренеры</span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
            ...
            <ul class="versality__ul">
              ...
              <li class="versality__li">
                ...
                <span>Дизайнеры, таргетологи, копирайтеры</span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
                  <img src="img/versatility-12.svg" alt="img" loading="lazy">
                </div>
                <span>Блогеры и лидеры мнений</span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
                  <img src="img/versatility-4.svg" alt="img" loading="lazy">
              ...
              <li class="versality__li">
                ...
                <span>Все, кого есть за что рекомендовать</span>
              </li>
            </ul>
          </div>
        </div>
...
-->
        <a href="consult/?<?=$par_url?>" class="service__link" >Как это работает</a>
      </div>
...
-->
            <div class="partner__div2">
              Подключайтесь, становитесь VIP партнером и зарабатывайте пожизненно до 30% со всех платежей от ваших рефералов.
            </div>
