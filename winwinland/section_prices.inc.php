...
-->
          <span>Абонетская плата фиксирована и не зависит от количества лидов, партнеров, оферов или других факторов.
          <a href='consult/?<?=$par_url?>' class='' target='' style='color:white; font-size:10pt;'>Оставить заявку</a>
          </span>
        </div>
...
-->
          <span>Абонетская плата фиксирована и не зависит от количества лидов, партнеров, оферов или других факторов.
          <br>
          <a href='consult/?<?=$par_url?>' class='service__link' target='' style='margin-top:30px;' style_='color:white; font-size:10pt;'>Оставить заявку</a>
          </span>
        </div>
