...
$db=new db("vkt");
$db->telegram_bot="vkt";
$db->db200="https://winwinland.ru/db1";
      ...
      <div class="container">
        <div class="possibilities">
          ...
          <h3 class="possibilities__suptitle title">
            Настройте один раз — монетизируйте постоянно
          </h3>
            ...
            <div class="possibilities__right">
              <div class="possibilities__item">
                ...
                <div class="possibilities__item-right">
                  Быстрый запуск для тех, у кого нет сайта — встроенный конструктор для простых
                  лендингов
                </div>
              </div>
              <div class="possibilities__item">
                ...
                <div class="possibilities__item-right">
                  Организуйте прогрев аудитории — бесплатная рассылка в VK и Telegram (e-mail и
                  WhatsApp по запросу)
                </div>
              </div>
              <div class="possibilities__item">
                ...
                <div class="possibilities__item-right">
                  Получайте оплату на карты российских и зарубежных банков — подключение платежных систем (Продамус)
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="traffic__left">
            ...
            <ul class="traffic__ul">
              <li class="traffic__li">
                Регистрация на семинары и запись на диагностику или пробное занятие
              </li>
              <li class="traffic__li">
                Интеграция с сервисом проведения вебинаров bizon — авторассылка по факту посещения
              </li>
            </ul>
        ...
        <h2 class="settings__title-hidden title">
          Мы поможем вам с настройками — 100% гарантия успешного внедрения
        </h2>
        <div class="settings">
          ...
          <div class="settings__right">
            ...
            <ul class="settings__ul">
              ...
              <li class="settings__li">Настройка сервиса под ключ!</li>
              <li class="settings__li">Объединение с уже используемыми у вас программами</li>
              <li class="settings__li">Внедрение новых компонентов по запросу</li>
            </ul>
                  ...
                  <ul class="rates__item-hidden-ul">
                    ...
                    <li class="rates__item-hidden-li">
                      Доступ к полному функционалу, включая: <br>
                       ...
                       - подключение вебинаров и автовебинаров <br>
                       - создание партнерских программ для усиления сарафанного радио <br>
                       - дополнительный функционал для увеличения продаж
                    </li>
                  </ul>
                </div>
              </a>
            ...
            <div class="slide-rates">
              ...
              <a class="rates__item"
                ...
                <div class="rates__item-hidden">
                  ...
                  <ul class="rates__item-hidden-ul">
                    <li class="rates__item-hidden-li">
                      выявление продающих смыслов, составление оферов и разработка лид-магнитов
                    </li>
                    <li class="rates__item-hidden-li">
                      создание чат-ботов/лендингов
                    </li>
                    <li class="rates__item-hidden-li">
                      подключение PRODAMUS - прием платежей с карт и оформление рассрочек *
                    </li>
                    <li class="rates__item-hidden-li">
                      тестирование рассылок/ботов
                    </li>
                    <li class="rates__item-hidden-li">
            ...
            <div class="slide-rates">
              ...
              <a class="rates__item"
                ...
                <div class="rates__item-hidden">
                  ...
                  <img src="img/rates-3.png" alt="img" loading="lazy">
                  <div class="rates__item-hidden-text">
                    Бизнес пакет с созданием маркетинговой стратегии «под ключ», что позволит:
                  </div>
                  <ul class="rates__item-hidden-ul">
                    <li class="rates__item-hidden-li">
Определить свою позицию на рынке и выделиться среди конкурентов
                    </li>
                    <li class="rates__item-hidden-li">
Разработать план маркетинговых мероприятий и определить их приоритетность
                    </li>
                    <li class="rates__item-hidden-li">
Определить ключевые сообщения и преимущества продуктов/услуг
                    </li>
                    <li class="rates__item-hidden-li">
Определить конкурентное преимущество и уникальное предложение бренда
                    </li>
                    <li class="rates__item-hidden-li">
Помочь бренду стать известным и знакомым для целевой аудитории, увеличить продажи
                    </li>
                  </ul>
            ...
            <div class="swiper-slide slide-hidden">
              ...
              <a class="rates__item"
                ...
                <div class="rates__item-hidden">
                  ...
                  <ul class="rates__item-hidden-ul">
                    <li class="rates__item-hidden-li">
                      составление оферов и разработка лид-магнитов
                    </li>
                    <li class="rates__item-hidden-li">
                      создание чат-ботов/лендингов
                    </li>
...
Определить ключевые сообщения и преимущества продуктов/услуг
                    ...
                    <li class="rates__item-hidden-li">
Определить конкурентное преимущество и уникальное предложение бренда, помочь бренду стать известным и <b>увеличить продажи</b>
                    </li>
                  </ul>
                </div>
              </a>
    ...
    <section class="partner" id="partner">
      <div class="container">
        ...
        <div class="partner__inner">
          <div class="partner__left">
            ...
            <div class="partner__div1">
              Ваши клиенты готовы вкладывать в дизайн и рекламу, но буксуют на обработке заявок?
            </div>
            <div class="partner__div2">
              Предложите им <span>Winwinland</span> — сервис автоматизации продаж и активации
              сарафанного радио.
            </div>
        ...
        <a class="partner__link" href="https://winwinland.ru/db1/2/?bc=<?=$bc?>"> Подробно о партнерской программе </a>
      </div>
    </section>
