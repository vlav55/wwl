    ...
    <section class="service" id="service">
      ...
      <div class="container">
        <div class="possibilities">
          <h2 class="possibilities__title">Возможности сервиса</h2>
          <h3 class="possibilities__suptitle title">
            Настроим для вас — монетизируйте постоянно
          </h3>
            ...
            <div class="possibilities__right">
              <div class="possibilities__item">
                ...
                <div class="possibilities__item-right">
                  Создавайте партнерские программы для любых ваших продуктов 
                </div>
              </div>
              <div class="possibilities__item">
                <div class="possibilities__item-left">2.</div>
                <div class="possibilities__item-right">
                  Формируйте лэндинги, подписывайте на чат боты и делайте рассылки
                </div>
              </div>
              <div class="possibilities__item">
                <div class="possibilities__item-left">3.</div>
                <div class="possibilities__item-right">
                  Подключите Продамус и принимайте оплату с карт российских и зарубежных банков.
                </div>
              </div>
              <div class="possibilities__item">
                <div class="possibilities__item-left">4.</div>
                <div class="possibilities__item-right">
                  Продавайте больше с помощью вебинаров и автовебинаров.
                </div>
              </div>
            </div>
          </div>
        ...
        <h3 class="traffic__title-hidden title">
          Усильте сарафанное радио — получайте больше заказов
        </h3>
        <div class="traffic">
          <div class="traffic__left">
            ...
            <ul class="traffic__ul">
              <li class="traffic__li">
                Создайте партнерскую программу, ссылку для регистрации партнеров и партнерские кабинеты
              </li>
              <li class="traffic__li">
                Пусть участники партнерской программы вас рекомендуют и получают вознаграждение
              </li>
              <li class="traffic__li">
                Им нужно лишь передать ссылку, дать сосканировать QR код, упомянуть вас в соцсетях со своей ссылкой - вы получаете клиентов с рекомендаций
              </li>
            </ul>
            <div class="traffic__bottom">
              <img src="img/service-img-2.svg" alt="img" loading="lazy">
              <span>
                Резонанс для Сарафанного радио — партнерская программа для ваших клиентов
              </span>
            </div>
          </div>
          <div class="traffic__right">
            <img src="img/service-img-3.png" alt="img" loading="lazy">
          </div>
        </div>
        <div class="traffic__bottom traffic__bottom-hidden">
          <img src="img/service-img-2.svg" alt="img" loading="lazy">
          <span> Резонанс для Сарафанного радио — партнерская программа для ваших клиентов </span>
        </div>
        <a href="#rates" class="service__link">Выбрать тариф</a>
        <h2 class="settings__title-hidden title">
          Мы все сделаем за вас — 100% гарантия успешного внедрения
        </h2>
        <div class="settings">
          ...
          <div class="settings__right">
            <h3 class="settings__title title">
              Мы все сделаем за вас — 100% гарантия успешного внедрения
            </h3>
            <ul class="settings__ul">
              <li class="settings__li">Свой штат специалистов</li>
              <li class="settings__li">Настройка платформы под ключ!</li>
              <li class="settings__li">Полное сопровождение вашего бизнеса</li>
              <li class="settings__li">Внедрение техник запусков и разогрева клиентской базы</li>
				<li class="settings__li">CRM-система</li>
				<li class="settings__li">чат-боты для рассылки в ВК и Tg</li>
				<li class="settings__li">конструктор лендингов</li>
				<li class="settings__li">партнёрская программа</li>
				<li class="settings__li">отчеты по рассылкам</li>
				<li class="settings__li">встроенный мессенджер</li>
				<li class="settings__li">прием платежей с карт и банковские рассрочки для клиентов</li>
				<li class="settings__li">создание вебинаров и автовебинаров </li>
            </ul>
          ...
          <div class="versality__inner">
            ...
            <ul class="versality__ul">
              <li class="versality__li">
                ...
                <span>Бьюти сервис: парикмахеры, стилисты, визажисты, мастера маникюра, депиляции,
                  косметологи</span>
              </li>
              <li class="versality__li">
                <div class="versality__li-img">
              ...
              <div class="swiper-item">
                ...
                <div class="swiper-item__right">
                  <div class="swiper-item__text">
                    ...
                    <u>сотрудник интеллектуального кооператива Альянс 78.2</u>
                  </div>
                  <div class="swiper-item__text">
              ...
              <div class="swiper-item">
                ...
                <div class="swiper-item__right">
                  <div class="swiper-item__text">
                    ...
                    <u>предприниматель, инвестор, независимый директор</u>
                  </div>
                  <div class="swiper-item__text">
              ...
              <div class="swiper-item">
                ...
                <div class="swiper-item__right">
                  <div class="swiper-item__text">
                    ...
                    <u>руководитель команды тех. агентства</u>
                  </div>
                  <div class="swiper-item__text">
                  ...
                  <div class="swiper-item__text">
                    Особенно радует, что платформа подходит для новичков экспертов, которым нужен сайт, рассылки, CRM,
              ...
              <div class="swiper-item">
                ...
                <div class="swiper-item__right">
                  <div class="swiper-item__text">
                    ...
                    порекомендовали эты платформу для усиления сарафанного радио.
                  </div>
                  <div class="swiper-item__text">
    ...
    <section class="partner" id="partner">
      <div class="container">
        ...
        <div class="partner__suptitle-hidden">
              У нас предусмотрена партнерская программа для вас на особых условиях.
        </div>
        <div class="partner__inner">
          ...
          Приведите трех человек и пользуйтесь платформой бесплатно или выводите деньги на карту.
            ...
            <div class="partner__div2">
              Подключайтесь и зарабатывайте до <span>40%</span> с каждого абонентского платежа от ваших рефералов.
            </div>
      ...
      <div class="container">
        ...
        <div class="questions__items">
          <div class="questions__item">
            <a class="questions__item-title">Будет ли платформа работать в моём бизнесе?</a>
            <div class="questions__item-content">
              <div class="questions__item-left">
                ...
                <div class="questions__item-bottom">
                  ...
                  ваше подключение к платформе ВИНВИНЛЭНД, как начало сотрудничества.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="questions__item">
            ...
            <div class="questions__item-content">
              <div class="questions__item-left">
                <div class="questions__item-top">
                  WinWinLand интегрирован с платежной системой Продамус. Возможно также сделать интеграцию
            ...
            <div class="questions__item-content">
              <div class="questions__item-left">
                <div class="questions__item-top">
                  ...
                  логин с паролем для входа на платформу. Доступ предоставляется на оплаченный период, продлить доступ можно в любое
                  время
                </div>
              </div>
            </div>
          ...
          <div class="questions__item">
            ...
            <div class="questions__item-content">
              <div class="questions__item-left">
                <div class="questions__item-top">
                  Да, это абсолютно безопасно. У нас заключен договор с проверенной и надежной
                  платежной системой Продамус, через которые и идет прием платежей. Продамус
                  действует в соответствии с законодательством и контролируется органами финансового надзора.
                </div>
              </div>
            </div>
          </div>
