...
function showSwiper__() {
  let widthScreen = window.innerWidth;

  // Only initialize Swiper if we're not using CSS Grid
  // You can keep this for larger screens or remove it entirely
  if (widthScreen < 1161 && widthScreen > 768) {
    let rates = new Swiper('.swiper-hidden', {
      freeMode: true,
      slidesPerView: 'auto',
      spaceBetween: 15,
    ...
    // On mobile (< 768px) and desktop (> 1160px), CSS Grid handles it
    // No Swiper needed
  }
}
