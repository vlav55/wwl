<?
include_once "/var/www/vlav/data/www/wwl/inc/pay_alfa.1.inc.php";
exit;
?>
<?
...
if(isset($_POST['go_submit'])) {
	...
	$cart[]=['name' => $descr, //	Наименование экземпляра товара. Строка, не более 128 символов длиной.	Да
		'price' => $amount, //	Стоимость единичного экземпляра товара	Да
		'quantity' => 1, //	Количество экземпляров товара в данной позиции	Да
		'sum' => $amount, //	Полная сумма к уплате по данной товарной позиции, включая НДС	Да
		'tax' => 63, //	Код налога, применяющегося к данной позиции	Да
	];
