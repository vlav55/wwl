<?
include_once "/var/www/vlav/data/www/wwl/inc/pay_robokassa.1.inc.php";
exit;
...
$mrh_login = $db->dlookup("robokassa_id","pay_systems","1");     // login
$mrh_pass1 = $db->dlookup("robokassa_passw_1","pay_systems","1"); // merchant pass1
