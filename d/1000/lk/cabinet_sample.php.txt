...
define('CLIENT_SECRET',''); //заполнить данные для авторизации https://help.winwinland.ru/docs/avtorizatsiya/
define('CLIENT_ID','');
...
if(!isset($res['uid'])) {
	if(CLIENT_SECRET==='')
		echo "Необходимо указать данные для авторизации
			<a href='https://help.winwinland.ru/docs/avtorizatsiya/' class='' target=''>https://help.winwinland.ru/docs/avtorizatsiya/</a>
			<br>";
	die("Error login");
	exit;
}
...
<body>
  <div class="cabinet-container">
    ...
    <div class="cabinet-block">
      ...
      <div>ТГ:</div>
        <a href="https://your_site.ru/?bc=<?=$res['partner_code']?>" target="_blank">перейти на лэндинг</a>
        <span style="word-break:break-all; margin-left:8px;">https://your_site.ru/?u=<?=$res['partner_code']?></span>
        <button class="cabinet-btn" style="display:inline-block; margin-left:8px;"
        onclick="navigator.clipboard.writeText('https://your_site.ru/?bc=<?=$res['partner_code']?>')">скопировать ссылку</button>
    ...
    <small style="display:block; margin:36px auto 18px auto;max-width:900px;">
      ...
      <a href="" target="_blank">Политикой конфиденциальности</a> и условиями
      <a href="" target="_blank">ДОГОВОРА ОФЕРТЫ ОБ УЧАСТИИ В ПАРТНЕРСКОЙ ПРОГРАММЕ</a>
    </small>
  </div>
</body>
</html>
